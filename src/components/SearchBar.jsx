...
function SearchBar() {
    ...
    return (
        <div className="relative w-2/3 text-gray-600">
            <input value={search} onChange={handleSearch} type="search" name="search" placeholder="Search..." autoComplete="off" className={`w-full h-10 px-5 pr-10 text-sm rounded-full ${theme === 'dark' ? 'bg-dark-tertiary' : 'bg-light-tertiary'} focus:outline-none`} />
